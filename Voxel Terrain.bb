...
Global heightImage = LoadImage("map28.height.png")
Global colorImage = LoadImage("map28.color.png")
...
While Not KeyHit(1)
    ...
    ; Adjust the target angle and height based on input
    If KeyDown(203) Then cam\targetAngle = cam\targetAngle - 5
    If KeyDown(205) Then cam\targetAngle = cam\targetAngle + 5
